...
# Green check ✅ indicates my modifications
...
def render_item(type_, obj, autogen_context):
    ...
    Tells Alembic how to handle custom types like UTCDateTime.
    """
    if type_ == "type" and isinstance(obj, UTCDateTime):
        # Add import statement to migration file
        autogen_context.imports.add(
            "from url_checker.helpers.custom_types import UTCDateTime"
        )
        # Return the string representation
        return f"UTCDateTime(timezone={obj.timezone})"
