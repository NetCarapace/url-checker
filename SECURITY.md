...
Security is an important concern for URLChecker so we welcome responsible reports of vulnerabilities.

## Scope

This policy applies to:

- The URLChecker source code and default configuration shipped in the public repositories.
...
If you believe you have found a security vulnerability in URLChecker, please contact:

- **Primary contact:** cedric.renzi+github_perso@restena.lu
- **Suggested subject line:** `Security issue in URLChecker`
